...
<div class="container-fluid px-4">
    ...
    <div class="mb-4">
            <a href="{{route('presentacione.create')}}">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                ...
                                <form action="{{route('presentacione.edit',['presentacione'=>$item])}}" method="get">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {{$item->caracteristica->estado == 1 ? '¿Seguro que quieres eliminar la Presentacion?' : '¿Seguro que quieres restaurar la categoria?' }}
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                    <form action="{{ route('presentacione.destroy',['presentacione'=>$item->id]) }}" method="post">
                                        @method('DELETE')
                                        @csrf
